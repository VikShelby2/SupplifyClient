...
export default function Navbar({ openMobile  , backgroundColor , }) {
        ...
        <div className="px-2 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start ">
              <button onClick={() => { openMobile() }} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
              ...
              <a href="https://flowbite.com" className="flex ms-2 md:me-5">
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white"> <img src={backgroundColor ==='white' ? blackLogo : logo} className="h-8 me-3" alt="FlowBite Logo" /></span>
              </a>
            ...
            <div className="flex items-center">
              ...
              <div className="flex ml-1 items-center   p-[5px] pr-up-btn rounded-[.5rem]"  style={{padding:'5px'}}>
              <SearchIcon className={'text-violet-400'} />
              </div>
              <div className="hidden sm:flex ml-1 items-center p-[5px] pr-up-btn rounded-[.5rem]" style={{padding:'5px'}}>
 ...
 <AuroraText  className={''}>{store.storeName}</AuroraText> <span className="text-violet-600 ml-1">Store</span>
    </h1>
              </div>
  ...
  <div className="">
    {store.svgData ? (
      <Button isIconOnly radius="full"> <Avatar isBordered color="secondary" radius="full" className="w-[30px] h-[30px]" src={dataUri} /></Button>
    ) : (
      <div className="relative w-8 h-8 bg-red-100 flex justify-center items-center rounded-lg">
        <span>MS</span>
      </div>
