...
export default function SkuModal({openModal , handleFieldChange , variantChanges ,setOpenModal ,setSku , sku , handleSave}){
    ...
    return(
        ...
        <ModalContent className="bg-[#1d1d1d]">
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1 text-white">Edit Sku</ModalHeader>
              <ModalBody>
         ...
         <form class=" m-0 ">
              ...
              }} class="text-[.834rem] text-white pl-[2px]">SKU (Stock per unit)</label>
                 <div class="relative">
