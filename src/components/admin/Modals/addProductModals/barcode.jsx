...
export default function BarcodeModal({openModal , setOpenModal ,handleFieldChange ,setBarcode , barcode , handleSave , variantChanges}){
    ...
    return(
        ...
        <ModalContent className="bg-[#1d1d1d]">
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1 text-white">Edit Barcode</ModalHeader>
              <ModalBody>
         ...
         <form class=" m-0 ">
              ...
              }} class="text-[.834rem] text-white pl-[2px]">Barcode</label>
                 <div class="relative">
