      ...
      >
        ...
        >
          {filteredOptions.length > 0 ? (
            ...
            <div className="grid  text-sm text-black items-center justify-center">
              <span style={{ textAlign: 'center' }}>
                No collection matching
              </span>
              <Link>
                <span className="text-blue-700 hover-underline-animation-link">
                  Create new collections here
                </span>
              </Link>
            </div>
          )}
