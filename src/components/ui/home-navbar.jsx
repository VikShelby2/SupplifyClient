...
export const MenuItem = ({
  ...
  return (
    (<a onMouseEnter={() => setActive(item)} className="" style={{padding: '.6rem .5rem .5rem' , fontSize:'20.8px'}}>
      <motion.p
        transition={{ duration: 0.3 }}
        className="group flex justify-center gap-5 items-center relative">
          <h1 className="text-base text-[1rem] font-medium text-white  line-clamp-1" style={{fontSize:'1.2rem'}}>{item}</h1>
