...
export function PlusCircle({className}){
  ...
  return(
    ...
    <path strokeLinecap="round" fill="none" strokeLinejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
...
return(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
...
export function Dollar(){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6 ml-[.3rem]">
...
export function EmptyImage({classStyle}){
  ...
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class={`w-6 h-6 ${classStyle}`}>
...
export function Ellipses({className ,  props , click}){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{fill:'none'}} className={`size-6  ${className}`}   {...props}>
...
export function RightArrowIcon({props}){
  return(
    <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6" props>
...
export function DottedIcon({className}){
  return(
    <svg fill="#000000" className={`${className} text-white w-4 h-4`} viewBox="0 0 27 27" xmlns="http://www.w3.org/2000/svg">
...
export function ChevronDown({style}){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-4 ${style}`}>
...
export function Bold(){
  return(
    <svg fill="#4a4a4a" className="w-4 h-4" version="1.1"  xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 202 202" >
...
export function  Italic(){
  return(
    <svg  viewBox="0 0 24 24" fill="#4a4a4a" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg">
