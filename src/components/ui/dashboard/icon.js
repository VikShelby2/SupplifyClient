...
export function AnalisticsIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function TrashIcon({ style }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function EmptyImage({ classStyle }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function Ellipses({ className, props, click }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const SearchIconSec = (props) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export function DottedIcon({ className }) {
  return (
    <svg
      fill="#000000"
      className={`${className} text-white w-4 h-4`}
      viewBox="0 0 27 27"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
...
export function ChevronDown({ style }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
