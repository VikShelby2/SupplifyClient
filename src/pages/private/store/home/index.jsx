...
<div className="w-full h-fit gap-3 grid  justify-center  p-6">
  ...
  <div className="grid grid-cols-3 items-center gap-3">
    <div className={'flex items-center p-1 w-full h-[150px] bg-white  rounded-xl '}>
...
const P2WideCard = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
        ...
        <div className='flex items-start w-full'>
          <p className='text-gray-400'>Find out what you missed in a click , check out your sales  , progress and new added features</p>
