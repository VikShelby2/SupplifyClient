  ...
  return (
    <>
      <Card
        ...
        class="bg-white shadow-input rounded-[.75rem] gap-2"
      >
        <CardContent className="mt-[1.3rem]">
          <div className="grid ">
            ...
            {checked && (
              <>
                {' '}
                <div className="w-full pl-[2px] flex items-center justify-between">
                  <p
                    ...
                    <div className="w-[50%]">
                      ...
                      >
                        <input
                          ...
                          name="countries"
                          value="used"
                          class=" custom-radio h-5 w-5 border-gray-300  focus:text-black "
                ...
                <div className="grid grid-cols-2 items-center justify-between">
                  <div className="p-2 px-0 flex items-center jusitfy-start w-full">
                    <FormLabel className={'text-black'}>Age range</FormLabel>
                  </div>
                  <div className="p-2 flex items-center gap-2 jusitfy-start w-full">
                    <SelectBasic
                      arr={ageRanges}
                      value={selectedAgeRange}
                      setValue={setSelectedAgeRange}
                ...
                <div className="grid grid-cols-2 items-center justify-between">
                  ...
                  <div className="p-2 flex items-center gap-2 jusitfy-start w-full">
                    <SelectBasic
                      ...
                      label={'Gender'}
                      placeholder={'gender for your product'}
                    />
                  </div>{' '}
                </div>
              </>
        ...
        {!checked && (
          <CardFooter class="border-t p-[16px]">
