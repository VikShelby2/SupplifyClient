...
import { Tooltip, Checkbox, Button, Select, SelectItem } from '@nextui-org/react';
...
useEffect(()=>{console.log(weightUnit)},[weightUnit])
  return (
    <FormCard 
       ...
       cardFooter={
     !checked && ( <div className='w-full flex items-center justify-start text-gray-500 text-[.8rem]'>
