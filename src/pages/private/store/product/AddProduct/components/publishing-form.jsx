...
const PublishingForm = ({ updateMyStore, updatePOS, input, open, setOpen }) => {
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between">
        <FormLabel className={'text-black'}>Publishing</FormLabel>
        <Dropdown
          classNames={{
        ...
        >
          ...
          >
            <DropdownItem
              ...
              key="Heading 1"
            >
              Menage Sales channel
            </DropdownItem>
            <DropdownItem hideSelectedIcon key="Heading 2">
              Menage Marketing
            </DropdownItem>
          </DropdownMenu>
        </Dropdown>
      ...
      <div className="flex mt-2 flex-col mb-2">
        <FormLabel className={'text-black text-[.85rem]'}>
          {' '}
          Sales Channels
        </FormLabel>
        <div className="mt-2 flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            <Badge
              variant={'outline'}
              className={
                'flex items-center justify-center rounded-[.3rem]  gap-1 p-1 px-2 border'
              }
            >
