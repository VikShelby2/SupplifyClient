...
export default function Inventory({
  ...
  return (
    ...
    >
      <div class="grid items-center ">
        <div className="grid grid-cols-2 items-center justify-between">
          <div className="p-2 px-[6px] flex items-center justify-start w-full">
            <FormLabel className={'text-black text-[1rem]'}>Quantity</FormLabel>
          </div>
          ...
          <div className="p-2 flex items-center gap-2 justify-end w-full">
            ...
            >
              <div class="flex items-center gap-x-1.5">
                ...
                <input
                  class="p-0 w-6 bg-transparent border-0 text-black text-center focus:ring-0 dark:text-white"
                  type="text"
                  value={count}
      ...
      <div className="grid grid-cols-2 items-center justify-between    pt-0">
        <div className="p-2 px-[4px]  flex items-center jusitfy-start w-full">
          <div className="grid pl-[2px] ">
            <label
              for="small-input"
              class="block  text-[1rem] font-medium text-black dark:text-white"
              style={{
                fontWeight: '500',
              }}
            >
      ...
      <div
        className={` align-center justify-center border-t-2 border-t-[#f1f1f1]   border-b-2 border-b-[#f1f1f1]`}
      >
        <div
          className={` p-[1.2rem] px-[4px] ${showInventory ? 'pb-[1.2rem]' : 'pb-1'} `}
        >
          <div class="flex items-center mb-4 p-[2px]">
            ...
            >
              This product has sku and barcode
            </label>
          </div>
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-[.5rem] ${showInventory ? '' : 'hidden'}`}
          >
      ...
      <div className="grid grid-cols-2 items-center justify-between   pt-[1.2rem] px-[6px] pb-0">
        <div className="p-2 px-0   flex items-center justify-start w-full">
          <div className="grid pl-[2px] ">
            ...
            >
              Allowing offers increases your chances of selling by 3-7% based on
              recent individual seller listing preformance .
            </p>
          </div>
        </div>
