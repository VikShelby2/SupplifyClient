...
const Header = ({  productSaved , handelEditProduct, handleSubmit, titleFilled  , store}) => {
  ...
  return (
    <div className="grid grid-cols-1 w-full items-center gap-4">
      ...
      {titleFilled && !productSaved && (
        ...
        >
         <Alert color='secondary'  variant="faded" className={{
          base: ''
         }} description={''} title={'Unsaved Product'} endContent={<div className="items-center gap-2 flex justify-end">
            <button 
              variant="outline" 
              size="sm" 
              className="pr-up-btn-dark"
...
<motion.div
          ...
          className="w-full items-center rounded-md  gap-2 md:ml-auto flex justify-between"
        >
         <Alert color='success'  variant="faded" className={{
          base: ''
         }} description={''} title={'Product Saved'} endContent={<div className="items-center gap-2 flex justify-end">
            <button 
              variant="outline" 
              size="sm" 
              className="pr-up-btn-dark"
