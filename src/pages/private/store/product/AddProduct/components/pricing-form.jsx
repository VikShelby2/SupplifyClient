  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2  grid-cols-1 gap-3 mr-0 flex items-center">
        <form class="">
          <FormLabel className={'text-black pl-[2px]'}>Pricing</FormLabel>
          <div class="relative">
        ...
        <div class="flex items-center justify-start ml-1 mb-2">
          ...
          <label for="default-checkbox" class=" text-sm font-medium text-black">
      ...
      <div className={`flex items-center justify-between  mr-0   mt-[.3rem]`}>
        <form class={`  ${openTax ? 'md:mr-0' : 'w-[49%]'} `}>
          <div className="w-fill  flex items-center justify-between">
            ...
            <Tooltip
              showArrow={true}
              size="xl"
              content="Buyers wont see this"
              className="text-[#8c52f1] text-sm max-w-[150px]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        {openTax && (
          <>
            {' '}
            <form
              class={`max-w-sm mx-auto  ${openTax ? 'md:mr-0' : 'md:mr-[.4rem]'}`}
            >
              <FormLabel className={'text-black pl-[2px]'}>Profit</FormLabel>
              <div class="relative">
                <div class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
            ...
            <form
              class={`max-w-sm mx-auto  ${openTax ? 'md:mr-0' : 'md:mr-[.4rem]'}`}
            >
              <FormLabel className={'text-black pl-[2px]'}>Label</FormLabel>
              <div class="relative">
                <div class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                  <span className="text-lg text-[#000]">--</span>
                </div>
