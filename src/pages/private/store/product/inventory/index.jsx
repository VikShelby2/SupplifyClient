...
useEffect(()=>{
  ...
  const fetchData =  () => {
     dispatch( listProducts(store , setTabs , setNoProducts) )
  };
  fetchData()
},[store._id])
...
useEffect(()=>{
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    ...
    )} 
   {
    ...
    <NormalModal press={()=>{dispatch(handleAddTab(tabName , store._id , 'product-main-table'  ))}} open={openNewTabModal} setOpen={setOpenNewTabModal} title={'Create tab'}   actionText={'Save'} >
