  ...
  return (
    <AuthLayout>
      <div className="center gap-2">
        <h1 className="text-3xl tracking-[-0.10em] text-black dark:text-white font-bold">
          Supplify
        </h1>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        {user && user.email && !editEmail ? (
          <div className="w-full flex mb-3 justify-center items-center">
            <button
              ...
              className="group p-[4px] w-full rounded-[12px] bg-gradient-to-b from-white to-stone-200/40 shadow-[0_1px_3px_rgba(0,0,0,0.5)] active:shadow-[0_0px_1px_rgba(0,0,0,0.5)] active:scale-[0.995]"
            >
        ...
        <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-400">
          ...
          <Link to={'/signUp'}>
            <span className="font-bold text-bold text-purple-300">Sign Up</span>
          </Link>
        </p>
