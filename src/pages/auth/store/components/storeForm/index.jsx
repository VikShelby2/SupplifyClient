    ...
    <div className="flex items-center w-[500px] shadow-input h-auto flex-col p-5 pb-6 bg-white rounded-xl">
      <div className="grid gap-0 w-full text-[#303030]">
        <h1 className="text-[1.4rem] leading-tight">
          Give your store a name and a location
        </h1>
        <p
      ...
      <div className="w-full flex items-center">
        <form
          ...
          className="flex items-center mt-3 flex-col w-full gap-4"
        >
          <Controller
            name="storeName"
            control={control}
          ...
          <button
            type="submit"
            className="relative group/btn flex space-x-2 mb-0 pb-0 items-center justify-start px-4 w-full text-black rounded-md h-10 font-medium shadow-input bg-gray-50 dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_var(--neutral-800)]"
          >
